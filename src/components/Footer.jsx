        ...
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 bg-white">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                ...
                <div className="flex-1 flex flex-col md:flex-row items-start md:justify-end gap-10 md:gap-20">
                    {/* Enlaces de empresa */}
                    <div>
                        <h2 className="font-semibold mb-5 text-gray-800 text-lg">Company</h2>
                    ...
                    <div>
                        <h2 className="font-semibold mb-5 text-gray-800 text-lg">Get in touch</h2>
                        <div className="text-sm space-y-3">
                            <p className="hover:text-indigo-600 transition-colors duration-200 cursor-default">
                                +1-212-456-7890
                            </p>
                            <p className="hover:text-indigo-600 transition-colors duration-200 cursor-default">
                                contact@example.com
            ...
            {/* Copyright */}
            <div className="pt-4 text-center text-xs md:text-sm pb-5">
                <p>
                    Copyright 2024 ©{" "}
                    <a 
